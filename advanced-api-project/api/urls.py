...
urlpatterns = [
    ...
    path('books/<int:pk>/update/', UpdateView.as_view(), name='update-view'),  # Update an existing book
    path('books/<int:pk>/delete/', DeleteView.as_view(), name='delete-view'),  # Delete a book
]
